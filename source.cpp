...
int vitridau(string s,int j)
{
    ...
    // Cho j chạy hết chuỗi, dem=1 có nghĩa là đang có 1 dấu (, nếu tìm thấy dấu ( thì dem + 1, còn thấy ) thì dem-1.
    // Khi nào mà dem=0 có nghĩa là đã hết dấu ngoặc.
int timngoac(string s,int i)
{
    ...
    //Nếu vị trí đầu mà là dấu ( thì sẽ gọi hàm timngoac để tìm vị trí ). Nếu dấu ngoặc đóng ở cuối thì sẽ xóa 2 dấu ngoặc.
    //Xóa bằng string.erase
