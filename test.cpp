...
int main() {
/*
    cout << "The constructed tree from postfix expression " << postfix << " is:" << endl;
    cout << "      " << root->s << endl;
    cout << "     / \\" << endl;
    cout << "    " << root->left->s << "   " << root->right->s << endl;
    cout << "   / \\  " << endl;
    cout << "  " << root->left->left->s << "   " << root->left->right->s << endl;*/
    string s;
	...
	cout << "Bieu thuc la: ";
            ...
            inOrder(root);
            cout << endl;
	cout << "Gia tri bieu thuc la " << evaluate(root) << endl;
	return 0;
    return 0;
}